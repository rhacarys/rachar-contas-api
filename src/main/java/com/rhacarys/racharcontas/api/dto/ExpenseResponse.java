...
public record ExpenseResponse(
                ...
                @Schema(description = "Data de exclusão, presente apenas se a despesa foi removida (soft-delete)") Instant deletedAt,
        ...
        public record SplitResponse(
                        ...
                        @Schema(description = "Data de exclusão da divisão") Instant deletedAt) {
        }
